...
def gate2ground_scatter(slant_ranges: List[float],
                       reflection_height: float = 250, **kwargs):
    """
...
def gate2slant(rxrise:int, gate: int = 0, frang: int = 180, rsep: int = 45,
               nrang: int = None, center: bool = True, **kwargs):
    """
